...
namespace Hunted.Weapons
{
    public class Shotgun : Weapon
    {
        ...
        {
            if (coolDown > 50 && coolDown < 75) AudioController.PlaySFX("shotgunreload", 1f, 0f, 0f, owner.Position);
        ...
        public override bool Use(GameTime gameTime, bool trigger, Camera gameCamera, bool canCollide)
        {
            ...
            {
                ProjectileController.Instance.Add(ProjectileType.Shot, owner, Helper.PointOnCircle(ref owner.Position, 40, owner.Rotation - MathHelper.PiOver2), owner.Position - Helper.PointOnCircle(ref owner.Position, 100, owner.Rotation + MathHelper.PiOver2 + r + (((float)Helper.Random.NextDouble()*0.1f)-0.05f)), canCollide);
            }
